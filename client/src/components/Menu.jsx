        ...
        <Container type={type}>
            <Wrapper>
                ...
                {/* <a
                    target="_blank"
                    rel="noreferrer"
                    href='https://janmejaypanigrahi.netlify.app' style={{ textDecoration: "none", color: 'inherit' }}>
                    <Item>
                ...
                <a
                    target="_blank"
                    rel="noreferrer"
                    href='https://www.github.com/janmejaypanigrahi' style={{ textDecoration: "none", color: 'inherit' }}>
                    <Item>
